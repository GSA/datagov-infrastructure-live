...
variable "db_password" {
  description = "Master password for the crm database server."
}
...
variable "dns_zone_public" {
  description = "The public DNS zone to create the crm CNAME record in."
}
...
variable "instance_count" {
  description = "Number of crm instances to create."
  default     = 1
}
